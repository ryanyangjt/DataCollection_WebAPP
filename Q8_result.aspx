<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Q8_result.aspx.cs" Inherits="Q8_result" %>
        ...
        <div>
            ...
            <div>
                    <p class="CenterAligan">
                        <asp:Button ID="Button_Next" runat="server" Text="下一關" Enabled="true" Height="53px" Width="101px" style="display: none" OnClick="Button_Next_Click"/>
                    </p>
            </div>
        </div>
 <script>
