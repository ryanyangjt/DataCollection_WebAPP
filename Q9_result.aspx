<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Q9_result.aspx.cs" Inherits="Q9_result" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <hr />
            <div>
                <asp:Table ID="Table_Result" runat="server" Height="151px"  width="100%" HorizontalAlign="Center" Font-Size="XX-Large">
                    <asp:TableRow>
                        <asp:TableCell Width="30%" HorizontalAlign="Center" ></asp:TableCell>
                        <asp:TableCell Width="60%" HorizontalAlign="Left" >
                            <b>剩餘籌碼</b>: <asp:Label ID="Temp_Score" runat="server" Text=" "></asp:Label> <br/>
                            <b>判斷結果</b>: <asp:Label ID="result" runat="server" Text=" " ForeColor="#CC0000"></asp:Label> <br/>
                            <b>累積籌碼</b>: <asp:Label ID="Temp_total" runat="server" Text=" " Font-Bold="True" ForeColor="#0033CC"></asp:Label>
                        </asp:TableCell>
                        <asp:TableCell Width="10%" HorizontalAlign="Center" ></asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            ...
            <div>
                    <p class="CenterAligan">
                        <asp:Button ID="Button_Next" runat="server" Text="結算籌碼" Enabled="true" Height="53px" Width="101px" style="display: none" OnClick="Button_Next_Click"/>
                    </p>
            </div>
        </div>
 <script>
...
function stopRecordingCallback() {
    ...
    this.save(document.getElementById('std_Label').innerText + '_1_2');
