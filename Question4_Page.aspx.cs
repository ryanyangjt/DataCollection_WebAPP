...
public partial class Question4_Page : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Session["Q4_you_me"] = c1.ToString() + " vs " + c2.ToString();
    ...
    {
        Session["Q4"] = Button_Cal.Text;
        Response.Redirect("Q4_result.aspx");
    }
    protected void Button_Cal_Click2(object sender, EventArgs e)
    {
        Session["Q4"] = Button_Cal2.Text;
        Response.Redirect("Q4_result.aspx");
    }
}